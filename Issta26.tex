...
%%% by Li Lin, Qinglin Zhu, Hongqiao Chen, Zhuangda Wang, Rongxin Wu, and Xiaoheng Xie.
%%%
%\setcopyright{cc}
%\setcctype{by}
%\acmDOI{10.1145/3728908}
%\acmYear{2025}
%\acmJournal{PACMSE}
%\acmVolume{2}
%\acmNumber{ISSTA}
...
%\title{Revisiting Text-to-SQL Generation: Beyond Accuracy Towards Efficiency}
\title{Cracking Query Bottlenecks: Towards Efficiency-Oriented Text-to-SQL Generation}
